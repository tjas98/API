...
var uporabljajTedenskiUrnik = (req, res) => {
...
var uporabljajStalenUrnik = (req, res) => {
    ...
    Promise.all([a,b,c]).then(() => {
        model.StalenStalenDijaki.find({}).then(function(rez) {
            model.StalenStalenProfeosorji.find({}).then(function(rez2) {
        ...
        model.StalenStalenZaProfesorja.find({}).then(function(rez) {
